...
- changed SQL table fields in Admin::projectSpecificSections, Admin::sectionDivisionsProducts to comply the dist app tables
...
- some Assertions changed to conditions to prevent Exceptions generated by stricter Assertions
