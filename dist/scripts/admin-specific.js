...
$(document).ready(function () {
    ...
    $('.database input[name=fields\\[url_en\\]]').on('change keyup paste', function (event) {
        selectWithNullOnChange(this, 'url_en');});
    $('.database input[name=fields\\[url_cs\\]]').on('change keyup paste', function (event) {
        selectWithNullOnChange(this, 'url_cs');});
    $('.database input[name=fields\\[url_de\\]]').on('change keyup paste', function (event) {
        selectWithNullOnChange(this, 'url_de');});
    $('.database input[name=fields\\[url_fr\\]]').on('change keyup paste', function (event) {
        selectWithNullOnChange(this, 'url_fr');});
    // redirector new_url
    ...
    $('.database textarea[name=fields\\[content_en\\]]').on('summernote.change', function (we, contents) {
        selectWithNullOnChangeContent(contents, 'content_en');});
    $('.database textarea[name=fields\\[content_cs\\]]').on('summernote.change', function (we, contents) {
        selectWithNullOnChangeContent(contents, 'content_cs');});
    $('.database textarea[name=fields\\[content_de\\]]').on('summernote.change', function (we, contents) {
        selectWithNullOnChangeContent(contents, 'content_de');});
    $('.database textarea[name=fields\\[content_fr\\]]').on('summernote.change', function (we, contents) {
        selectWithNullOnChangeContent(contents, 'content_fr');});
