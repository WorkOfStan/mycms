...
session_start() || error_log('session_start failed'); //Tracy is able to show Debug bar and Bluescreens for AJAX and redirected requests. You just have to start session before Tracy
